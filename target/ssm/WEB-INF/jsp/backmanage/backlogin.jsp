...
<head>
    ...
    <link href="<%=request.getContextPath()%>/back/assets/admin/pages/css/login2.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="<%=request.getContextPath()%>/back/assets/admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
    <link href="<%=request.getContextPath()%>/back/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
    <link href="<%=request.getContextPath()%>/back/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
...
<div class="logo">
    <a href="index.html">
        <img src="images/logo.png" style="height: 17px;" alt=""/>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="${pageContext.request.contextPath }/backloginsub.form" method="post">
        <div class="form-title">
            <span class="form-title">欢迎回来.</span>
        ...
        <div class="form-group">
            ...
            <label class="control-label visible-ie8 visible-ie9">管理员账号</label>
...
<script src="<%=request.getContextPath()%>/back/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<%=request.getContextPath()%>/back/assets/global/scripts/metronic.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/back/assets/admin/layout/scripts/layout.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/back/assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/back/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
